  ...
  render: async function () {
    ...
    do {
      ...
      for (let i = 0; i < list.length; i++) {
        ...
        await page.goto("https://metaearth.sbs/estate-view?id=" + tokenId);
...
app.get("/", async (req, res) => {
  res.send("MetaEarth Data Server 1.0 start in " + timeStart);
});
...
app.get("/uri", async (req, res) => {
  try {
    ...
    let tokenImg =
      "https://data.metaearth.sbs/shoot?tokenId=" + req.query.tokenId;
    let metaData = {
...
const web3 = new Web3("https://testnet-rpc.coinex.net");
let abi = [
  {
    constant: true,
    inputs: [
...
let mest = new web3.eth.Contract(
  abi,
  "0xf74bFB6FA061B482487170FD6e2ac11bC42e8514"
);
